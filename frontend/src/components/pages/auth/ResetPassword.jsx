                ...
                <div className="px-10 pb-12 pt-4">
                    ...
                    {success ? (
                        <div className="text-center animate-[fadeInUp_0.4s_ease-out]">
                            ...
                            <Link to="/login" className="flex items-center justify-center gap-2 w-full py-3.5 bg-gradient-to-r from-emerald-500 to-cyan-500 rounded-xl text-[#0d0f13] font-bold hover:scale-[1.01] transition-all shadow-lg shadow-emerald-500/10">
                                Back to Log In
                                <ArrowRight size={18} />
                            </Link>
                        </div>
                        ...
                        <div className="flex flex-col gap-8">
                            ...
                            >
                                {resetLoading ? "Verifying..." : "Verify Recovery Code"}
                            </button>
                        </div>
                    ) : (
                        <form onSubmit={handleResetPassword} className="flex flex-col gap-6">
                            <div className="flex flex-col gap-1.5">
                                ...
                                <div className="relative group">
                                    <input
                                        ...
                                        className="w-full py-3.5 px-4 pl-12 bg-white/[0.03] border border-white/10 rounded-xl text-white text-sm outline-none transition-all focus:border-cyan-500/50"
                                        placeholder="••••••••"
                                        required
                                        value={newPasswords.password}
                                        onChange={(e) => setNewPasswords({ ...newPasswords, password: e.target.value })}
                                    />
                                    <Lock size={18} className="absolute left-4 top-1/2 -translate-y-1/2 text-neutral-500 group-hover:text-cyan-400" />
                            ...
                            <button
                                ...
                                className="mt-2 py-4 bg-gradient-to-r from-emerald-500 to-cyan-500 rounded-xl text-[#0d0f13] font-bold transition-all shadow-lg shadow-emerald-500/20"
                            >
