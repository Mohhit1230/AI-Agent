...
const Home = ({ showPreloader }) => {
            ...
            setHistory((h) => {
                const updated = [
                    ...h,
                    {
                        role: "model",
                        parts: [
                            { text: data?.data?.type === "image" ? data.data : (data?.data?.text || data?.data?.[0] || data.parts) },
                        ],
                    },
                ];
    ...
    return (
        <>
            <div className={`flex  min-h-screen ${showPreloader ? 'h-screen overflow-hidden' : ''}`}>
                                ...
                                {selectMode ? (
                                    ...
                                    !isNewChat && (
                                        ...
                                        >
                                            ...
                                            <span className="text-[10px] font-bold uppercase tracking-widest hidden sm:inline">Select</span>
                                        </button>
                                    )
                                )}
                            </div>
                                            ...
                                            >
                                                ...
                                                <div
                                                    className={`relative max-w-[90%] md:max-w-[85%] group ${m.role === "user"
                                                        ...
                                                        : "text-[#e1e1e1] w-full"
                                                        } ${selectMode && selectedMessages.has(i) ? "ring-1 ring-red-500/50 rounded-xl" : ""}`}
                                                    onClick={selectMode ? () => toggleMessageSelection(i) : undefined}
