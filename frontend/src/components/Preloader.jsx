                    ...
                    >
                        ...
                        {[...Array(4)].map((_, i) => (
                            <div
                                ...
                                style={{ transform: `translateZ(${(i + 1) * 10}px)`, opacity: 0.3 }}
                            />
                        ))}

                        {/* Front Plate with Logo */}
                        <div className="relative w-full h-full bg-[#0a0a0a]/80 backdrop-blur-3xl rounded-[3rem] border border-white/10 p-10 flex items-center justify-center overflow-hidden shadow-2xl" style={{ transform: 'translateZ(45px)' }}>
                            {/* Dynamic light glint */}
                        ...
                        <div className="absolute -top-4 -left-4 w-12 h-12 border-t-4 border-l-4 border-cyan-400 rounded-tl-2xl shadow-[0_0_15px_rgba(34,211,238,0.5)]" style={{ transform: 'translateZ(60px)' }} />
                        <div className="absolute -bottom-4 -right-4 w-12 h-12 border-b-4 border-r-4 border-[#fd4444] rounded-br-2xl shadow-[0_0_15px_rgba(253,68,68,0.5)]" style={{ transform: 'translateZ(60px)' }} />
                    </div>
                </div>
